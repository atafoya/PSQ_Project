...
if ~exist("V13")
    error("You must run the simulink model first.")
    % sim("IEEE13bus_v2019b_Discrete_XXXXXXXX.slx")
end

% take the steady-state values at the last timestep of sim
% TODO: take samples at different solar irradiance levels
% Vs13=V13(end,:)';
Vs13=V13(end,:)';
...
titletext="Phase Voltages - "+casename+" - Power at PCC: "+string(round(Powers(1),2))+" kW + "+string(round(Powers(2),2))+" kvar";
title(titletext)
legend('Phase A','Phase B','Phase C')
xlabel('Bus')
ylabel('V pu ')
fontsize(16,'point');
saveas(gcf,casename+"-3ph"+".png")
