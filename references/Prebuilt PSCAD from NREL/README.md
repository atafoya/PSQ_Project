I took only the GFM-GFL Models which are the 9 bus items, [see the full repo here](https://github.com/NatLabRockies/PyPSCAD/tree/main#). 

They have a bunch of other stuff added, but it should be a decent starting point. 
